    ...
    <Layout>
      <>
        <section className='w-full h-auto'>
          {/* Home */}
          <div
            className='w-full h-3/4 border border-slate-300 
            dark:border-slate-600'
            id='home'>
            <div className='w-full h-full'>
              <div
                className='w-full h-full flex flex-col absolute space-y-96 py-6 items-center 
                ...
                <div
                  className='hidden h-auto pb-6 
                  lg:w-2/5 lg:flex'>
                  <p className='text-4xl ml-16 font-bold text-white'>Encuentra lo que necesites</p>
                </div>

                <button
                  className='w-48 rounded-full text-lg text-primary font-semibold p-4 bg-white 
              ...
              <div
                ...
                <img
                  className='lg:hidden'
                  src='../src/assets/img/azogues.jpeg'
                  alt='San Francisco Azogues'
                />
              </div>
            </div>
          </div>
          ...
          {/* Recomendados */}
          <div
            className='w-full h-auto divide-y divide-slate-400 dark:divide-slate-700
            ContentGrid'
            id='recommendations'>
            <p
              className='PageTitle pt-6 
              lg:w-4/5'>
              Recomendados
            </p>
            ...
            <div
              className='w-auto h-auto items-center mt-2 p-6 overflow-x-auto overscroll-x-contain flex space-x-6 
              scrollbar-hide
              lg:w-4/5'>
          ...
          <div
            ...
            {/* Realizado con Grid */}
            <div
              className='w-full h-full mt-2 p-6 grid grid-rows-4 grid-flow-col gap-6 
              lg:w-4/5'>
          ...
          <div
            ...
            <div
              className='w-full h-full mt-2 p-6 flex flex-col space-y-4
              lg:w-4/5'>
              <div>
              ...
              <div>
                ...
                <p className='text-sm pt-2 dark:text-white'>
                  Aceptamos distintos métodos de pago: VISA, MasterCard, American Express, Paypal y
                  Binance
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className='text-sm pt-2 dark:text-white'>
                  Contamos con estancias de hasta 3 meses, en este caso es requerido un anticipo con
        ...
        {/* FOOTER  */}
        <footer
          className='w-full h-auto bg-gray-200 text-gray-500 border border-slate-300 p-6 mt-6 space-y-2 rounded-t-3xl 
          dark:bg-gray-900 dark:text-white dark:border-slate-700'
          id='about_us'>
          <div className='p-6 w-full h-full'>
            <p
              className='text-lg text-primary font-bold pb-6 mt-6
              dark:text-white'>
              Sobre Nosotros
            </p>
          ...
          <p className='text-sm'>© 2024 Sistemas Gad Azogues all rights reserved</p>
        </footer>
      </>
    </Layout>
  );
